						...
						<tr>
							<td align="center" valign="top">
								...
								<table border="0" cellpadding="0" cellspacing="0" style="background-color:#FFFFFF;border-color:#E5E5E5; border-style:solid; border-width:0 1px 1px 1px;" width="100%" class="tableCard">
									...
									<tr>
										<!-- Header Top Border // -->
										<td height="3" style="background-color:#17d492;font-size:1px;line-height:3px;" class="topBorder">&nbsp;</td>
									</tr>
									...
									<tr>
										<td align="center" valign="top" style="padding-bottom:40px" class="imgHero">
											...
											<a href="#" target="_blank" style="text-decoration:none;">
												<img src="{{config('portal_settings.logo')}}" width="600" alt="" border="0" style="width:100%; max-width:500px; height:auto; display:block;" />
											</a>
										</td>
									</tr>
												...
												<tr>
													<td align="center" valign="top" style="padding-bottom:20px;" class="description">
														...
														<p class="text" style="color:#666666; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:14px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:22px; text-transform:none; text-align:center; padding:0; margin:0">
															Lorem ipsum dolor sit amet consectetur adipisicing elit. Itaque ea alias id laboriosam et a amet, illum deserunt, culpa repellendus est impedit delectus necessitatibus. Ipsum qui fugit suscipit dolorum voluptatem?
														</p>
													</td>
												</tr>
											</table>
												...
												<tr>
													<td align="center" valign="top" style="padding-top:20px;padding-bottom:20px;">
														...
														<table align="center" border="0" cellpadding="0" cellspacing="0">
															<tr>
																<td align="center" class="ctaButton" style="background-color:#17d492;padding-top:12px;padding-bottom:12px;padding-left:35px;padding-right:35px;border-radius:50px">
																	<!-- Button Link // -->
																	<a class="text" href="{{ $url }}" target="_blank" style="color:#FFFFFF; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:13px; font-weight:700; font-style:normal;letter-spacing:1px; line-height:20px; text-transform:uppercase; text-decoration:none; display:block">
																		Confirm Email
																	</a>
																</td>
															</tr>
