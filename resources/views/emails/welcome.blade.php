...
<head><style type="text/css" title="x-apple-mail-formatting"></style>
	<title>{{env('APP_NAME','Agency Suite')}} - Welcome</title>
				...
				<div mc:repeatable="Hero Section">
					...
					<tbody><tr>
						<td style="padding:0 30px" class="padded">
							...
							<tbody><tr>
								<td style="padding:20px 0;text-align:left;font-weight:500;font-size:24px;color:#343333" class="avenir" mc:edit="title">Hello {{$name}}, you’re a click away</td>
							  </tr>
							  <tr>
								<td style="padding:0 80px 0 0;font-size:18px;line-height:167%;font-weight:400;color:#343333" mc:edit="copy 1">
																						<p>Click the button to verify your email - your high performance, truly managed WordPress site awaits you 💪</p>
																		 </td>
							  </tr>
							  <tr>
								<td style="padding:30px 0 60px 0" mc:edit="button">
									...
									<div align="left">
										<a data-qa="verification_link" href="https://admin.typeform.com/login/" style="text-decoration:none;color:#FFFFFF;background-color:#143156;display:inline-block;padding:15px 20px;margin:auto;border:2px solid #343333;border-radius:3px;font-size:18px;font-weight:500" class="button">
																							Verify my email
																					</a>
									</div>
							...
							<tbody><tr>
								<td style="padding:20px 80px 0 0;font-size:16px;line-height:167%;font-weight:400;color:#343333" mc:edit="copy 2">
									<p>Or paste this link in your browser.<br> <a href="{{$url}}">{{$url}}</a>.								</p></td>
							</tr>
